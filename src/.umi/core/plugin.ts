...
import * as Plugin_0 from '/Users/ningshuo/code/my-projects/equipment-system/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/ningshuo/code/my-projects/equipment-system/src/app.tsx',
    },
    {
      apply: Plugin_1,
